...
export const Events = ({ events = fallbackEvents, className }: EventsProps) => {
  return (
            ...
            <div className="p-4 space-y-3">
              <div className="flex items-start justify-between">
                <div
                  className={cn(
                    'p-2 rounded-lg',
                    iconStyles[event.iconStyle as keyof typeof iconStyles]
                  )}
                >
                ...
                >
                  {React.createElement(statusConfig[event.status].icon, {
