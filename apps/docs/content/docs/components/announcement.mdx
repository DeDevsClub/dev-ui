...
import {
  ...
  AnnouncementTag,
  AnnouncementTitle,
} from '@/components/ui/dedevs-ui/announcement';
import { ArrowUpRightIcon } from 'lucide-react';

const Example = () => (
  <div className="flex w-full h-screen items-center justify-center gap-4 bg-primary">
    <Announcement>
...
const Example = () => (
  <div className="flex flex-col w-full h-screen bg-primary items-center justify-center gap-4">
