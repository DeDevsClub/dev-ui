...
<Preview name="buttons/pill" code={`'use client';
...
import {
  ...
  PillIcon,
  PillAvatarGroup,
} from '@/components/ui/dedevs-ui/buttons/pill';
import { ArrowUpRightIcon, XIcon, CheckCircleIcon, UsersIcon } from 'lucide-react';

const Example = () => (
  <div className="flex w-full h-screen items-center justify-center p-8 bg-primary text-primary-foreground">
    <div className="flex flex-wrap gap-2 items-center justify-center">
      <Pill>
        <PillAvatar src="https://pbs.twimg.com/profile_images/1748718473595789312/PbqJh9hk_400x400.jpg" fallback="BD" />
        @haydenbleasel
      </Pill>
      <Pill>
        <PillStatus>
...
<Installer packageName="buttons/pill" />
...
import { Pill, PillAvatar } from '@/components/ui/dedevs-ui/buttons/pill';

const Example = () => (
  <div className="flex w-full items-center justify-center p-8 h-screen bg-primary text-primary-foreground">
    <Pill>
      <PillAvatar src="https://x.com/0xbuns/photo" fallback="BD" />
      @0xbuns
    </Pill>
  </div>
);
...
import { Pill, PillStatus } from '@/components/ui/dedevs-ui/buttons/pill';
...
import { Pill, PillButton } from '@/components/ui/dedevs-ui/buttons/pill';
...
import { Pill, PillIndicator } from '@/components/ui/dedevs-ui/buttons/pill';

const Example = () => (
  <div className="flex w-full items-center justify-center gap-2 p-8 h-screen bg-primary text-primary-foreground">
    <Pill>
      <PillIndicator variant="success" pulse />
      Active
    </Pill>
...
import { Pill, PillDelta } from '@/components/ui/dedevs-ui/buttons/pill';
...
import { Pill, PillIcon } from '@/components/ui/dedevs-ui/buttons/pill';
...
import { Pill, PillAvatar, PillAvatarGroup } from '@/components/ui/dedevs-ui/buttons/pill';
...
<AutoTypeTable path="node_modules/@repo/buttons/pill.tsx" name="PillProps" />

### PillAvatar

The `PillAvatar` component is used to display an avatar.

<AutoTypeTable path="node_modules/@repo/buttons/pill.tsx" name="PillAvatarProps" />

### PillStatus

The `PillStatus` component is used to display a status.

<AutoTypeTable path="node_modules/@repo/buttons/pill.tsx" name="PillStatusProps" />

### PillButton

The `PillButton` component is used to display a button.

<AutoTypeTable path="node_modules/@repo/buttons/pill.tsx" name="PillButtonProps" />

### PillIndicator

The `PillIndicator` component is used to display an indicator.

<AutoTypeTable path="node_modules/@repo/buttons/pill.tsx" name="PillIndicatorProps" />

### PillDelta

The `PillDelta` component is used to display a delta.

<AutoTypeTable path="node_modules/@repo/buttons/pill.tsx" name="PillDeltaProps" />

### PillIcon

The `PillIcon` component is used to display an icon.

<AutoTypeTable path="node_modules/@repo/buttons/pill.tsx" name="PillIconProps" />

### PillAvatarGroup

The `PillAvatarGroup` component is used to display an avatar group.

<AutoTypeTable path="node_modules/@repo/buttons/pill.tsx" name="PillAvatarGroupProps" />