...
import {
  ...
  KanbanHeader,
  KanbanProvider,
} from '@/components/ui/dedevs-ui/kanban';
import type { DragEndEvent } from '@/components/ui/dedevs-ui/kanban';
...
const Example = () => {
  ...
  return (
    <KanbanProvider onDragEnd={handleDragEnd} className="p-4 bg-primary">
